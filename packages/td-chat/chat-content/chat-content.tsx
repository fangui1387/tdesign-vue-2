  ...
  setup(props) {
    ...
    const textInfo = computed(() => {
      ...
      if (typeof props.content === 'object' && props.content !== null) {
        const { type, data } = props.content as any;
        switch (type) {
          case 'text':
            return escape(data || '');
          case 'markdown':
    ...
    const renderContent = () => (
      <div class={[`${COMPONENT_NAME.value}__text`]}>
        {props.status === 'error' ||
        (typeof props.content === 'object' && (props.content as any)?.type === 'text') ||
          ...
          <ChatMarkdown
            content={
              typeof props.content === 'string'
                ? props.content
                : typeof props.content === 'object' && (props.content as any)?.type === 'markdown'
                ? (props.content as any).data
