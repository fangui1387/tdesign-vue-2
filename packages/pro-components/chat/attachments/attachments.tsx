...
import { ChevronLeftIcon, ChevronRightIcon, CloseIcon, FileIcon, ImageIcon, VideoIcon, SoundIcon, FolderIcon } from 'tdesign-icons-vue-next';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const renderFileCard = (item: TdAttachmentItem, index: number) => {
      ...
      return isImage && allImages.value ? renderImageCard() : renderFileCard();
    };
        ...
        <div class={wrapCls}>
          <div
            ...
            class={[
              listCls,
              {
                [`${listCls}--overflow-scrollX`]: props.overflow === 'scrollX',
                [`${listCls}--overflow-scrollY`]: props.overflow === 'scrollY',
                [`${listCls}--overflow-wrap`]: props.overflow === 'wrap',
              },
            ]}
          >
