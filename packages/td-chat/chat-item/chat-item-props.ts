...
export default {
  ...
  animation: {
    ...
    default: 'skeleton',
    validator: (value: string) => ['skeleton', 'moving', 'gradient'].includes(value),
  },
  /** 自定义的头像配置 */
  avatar: {
  ...
  role: {
    ...
    default: 'assistant',
    validator: (value: string) => ['user', 'assistant', 'error', 'model-change', 'system'].includes(value),
  },
  ...
  variant: {
    ...
    default: 'text',
    validator: (value: string) => ['base', 'outline', 'text'].includes(value),
  },
  status: {
